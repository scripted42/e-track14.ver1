...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Student Attendance Management - enforce permissions
        Route::prefix('student-attendance')->name('admin.student-attendance.')->middleware('role_or_permission:Admin|report.view|report.view_all')->group(function () {
        ...
        Route::prefix('leaves')->name('admin.leaves.')->group(function () {
            ...
            Route::post('/{leave}/approve', [LeaveController::class, 'approve'])->name('approve')->middleware('permission:leave.approve');
        ...
        // Student Promotion and Graduation - enforce permissions
        Route::get('/students/promotion', [\App\Http\Controllers\Web\StudentPromotionController::class, 'index'])
            ->middleware('role_or_permission:Admin|student.manage')
        ...
        Route::prefix('reports')->name('admin.reports.')->middleware('role_or_permission:Admin|report.view|report.view_all')->group(function () {
        ...
        Route::middleware('role_or_permission:Admin|report.view_all')->group(function () {
        ...
        Route::middleware('role_or_permission:Admin|report.view')->group(function () {
        ...
        // System Administration - Role & Permission (Admin only)
        Route::prefix('system')->middleware('role:Admin')->group(function () {
            // Friendly redirect for mistaken GET to PUT endpoint
            Route::get('/roles/{role}/permissions', function ($roleId) {
                return redirect()->route('admin.roles-permissions.index')
                    ->with('error', 'Gunakan tombol "Simpan" pada halaman Role & Izin untuk memperbarui izin.');
            });
            ...
            Route::delete('/roles/{role}', [RolePermissionController::class, 'destroyRole'])->name('admin.roles.destroy');
        });
    });
});