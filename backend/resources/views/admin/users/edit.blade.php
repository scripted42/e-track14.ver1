...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.users.show', $user) }}" class="btn btn-outline-secondary">Kembali</a>
    </div>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nip_nik" class="form-control" value="{{ old('nip_nik', $user->nip_nik) }}">
                            @error('nip_nik')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($user->photo && file_exists(public_path('storage/user-photos/' . $user->photo)))
                                <div class="mt-2">
                                    <img src="{{ asset('storage/user-photos/' . $user->photo) }}" alt="Foto" class="rounded-circle" style="width: 60px; height: 60px; object-fit: cover;">
                ...
                <div class="mb-3" id="walikelas-section" style="display: none;">
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="is_walikelas" id="is_walikelas" value="1" {{ old('is_walikelas', $user->is_walikelas) ? 'checked' : '' }}>
                        ...
                        <select name="class_room_id" class="form-control">
                            ...
                            @foreach($classRooms as $classRoom)
                                <option value="{{ $classRoom->id }}" {{ old('class_room_id', $user->class_room_id) == $classRoom->id ? 'selected' : '' }}>
                                    ...
                                    @if($classRoom->walikelas && $classRoom->walikelas->id != $user->id)
