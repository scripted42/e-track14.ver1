...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Import Staff</h1>
            <p class="text-muted mb-0">Import data staff secara massal dari file Excel</p>
        </div>
    ...
    <div class="import-card" id="uploadStep">
        ...
        <div class="import-body">
            ...
            <div class="text-center mb-3">
                <a href="{{ route('admin.users.import.template') }}" class="btn btn-template">
...
function previewData() {
    ...
    fetch('{{ route("admin.users.import.preview") }}', {
        method: 'POST',
        body: formData
    })
...
function populatePreviewTable() {
    ...
    previewData.forEach((row, index) => {
        ...
        if (!row.nip_nik || !row.nama || !row.email || !row.peran || !row.status) {
            isValid = false;
...
function importData() {
    ...
    fetch('{{ route("admin.users.import.process") }}', {
        method: 'POST',
        body: formData
    })
    .then(response => {
