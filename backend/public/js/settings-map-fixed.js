// Settings Map JavaScript - Fixed Version
...
function initMap() {
    ...
    try {
        ...
        console.log('Form inputs found:', {
            latitudeInput: latitudeInput ? latitudeInput.value : 'not found',
            longitudeInput: longitudeInput ? longitudeInput.value : 'not found',
            radiusInput: radiusInput ? radiusInput.value : 'not found'
        });
        
        // Use values from form or fallback to database values
        ...
        console.log('Map coordinates from form:', { latitude, longitude, radius });
        ...
        if (mapContainer) {
            ...
            console.log('Map container displayed, dimensions:', {
        ...
        if (mapStatus) {
            ...
            mapStatus.className = 'badge bg-danger';
        }
        if (mapInfo) {
            mapInfo.textContent = 'Gagal memuat peta';
        }
    }
}
...
function updateMap() {
    if (map && marker && circle) {
        ...
        // Update info display if elements exist
        const currentCoords = document.getElementById('currentCoords');
        const currentRadius = document.getElementById('currentRadius');
        const mapStatus = document.getElementById('mapStatus');
        const mapInfo = document.getElementById('mapInfo');
